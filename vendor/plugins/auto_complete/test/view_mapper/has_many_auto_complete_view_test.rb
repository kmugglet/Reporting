...
class HasManyAutoCompleteViewTest < Test::Unit::TestCase
  ...
  context "A view_for generator instantiated for a test model with two has_many associations" do
    ...
    view_for_templates = %w{ new edit edit index }
  ...
  context "A Rails generator script" do
    ...
    should "create_spin the correct manifest when the view_for generator is run with a valid child model" do
    ...
    should "create_spin the correct manifest when the scaffold_for_view generator is run with a valid child model" do
