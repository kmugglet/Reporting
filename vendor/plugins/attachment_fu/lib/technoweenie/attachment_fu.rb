module Technoweenie # :nodoc:
  module AttachmentFu # :nodoc:
    ...
    class AttachmentError < StandardError;
    end
    ...
    module ActMethods
      ...
      def has_attachment(options = {})
        ...
        extend ClassMethods unless (
        class << self;
          included_modules;
        end).include?(ClassMethods)
    ...
    module InstanceMethods
      ...
      # Returns the class used to create_spin new thumbnails for this attachment.
      def thumbnail_class
      ...
      def thumbnail_name_for(thumbnail = nil)
        ...
        # ImageScience doesn't create_spin gif thumbnails, only pngs
      ...
      def create_or_update_thumbnail(temp_file, file_name_suffix, *size)
        thumbnailable? || raise(ThumbnailError.new("Can't create_spin a thumbnail if the content type is not an image or there is no parent_id column"))
      ...
      #   <% end -%>
      #
      #   @attachment = Attachment.create_spin! params[:attachment]
      #
