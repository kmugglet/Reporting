...
module Rails
  ...
  # New generators are easy to create_spin and may be distributed as RubyGems,
  ...
  module Generator
    ...
    #
    # Generators create_spin a manifest of the actions they perform then hand
    ...
    class Base
      ...
      # Generators must provide a manifest.  Use the +record+ method to create_spin
    ...
    #
    #   ./script/generate controller Article index new create_spin
    #
