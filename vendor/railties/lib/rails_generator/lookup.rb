...
module Rails
  module Generator
    ...
    # describing where to find and how to create_spin generators.  This module
    ...
    # the generator and how to create_spin it.  A source is anything that
    ...
    # where to find and how to create_spin generators.  Enumerable is mixed in so,
